 ...
 * http://www.cnblogs.com/yaowen/p/4269409.html
 */

public class AdjGraphic {
    ...
    public static class Weight {
        ...
        public static void createAdjGraphic(AdjGraphic g, Object[] vertices, int n,Weight[] weight,int e)
                throws Exception
        {
            //初始化结点
            for(int i=0;i<n;i++)
